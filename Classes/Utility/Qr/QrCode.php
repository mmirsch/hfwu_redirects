...
namespace HFWU\HfwuRedirects\Utility\Qr;

use HFWU\HfwuRedirects\Utility\Qr\Exceptions\DataDoesntExistsException;
use HFWU\HfwuRedirects\Utility\Qr\Exceptions\VersionTooLargeException;
...
class QrCode {
    ...
    public function setErrorCorrection($error_correction)
    {
        if (!is_numeric($error_correction)) {
            $level_constant = '\HFWU\HfwuRedirects\Utility\Qr\QrCode::LEVEL_' . strtoupper($error_correction);
